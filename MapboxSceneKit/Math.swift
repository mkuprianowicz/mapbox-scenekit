...
public class Math {
    ...
    public static func metersToDegreesForLat(atLongitude longitude: CLLocationDegrees) -> CLLocationDistance {
    ...
    public static func metersToDegreesForLon(atLatitude latitude: CLLocationDegrees) -> CLLocationDistance {
    ...
    public static func latLng2tile(lat: Double, lon: Double, zoom: Int, tileSize: CGSize) -> (xTile: Int, yTile: Int, xPos: Double, yPos: Double) {
    ...
    public static func tile2LatLng(x: Int, y: Int, z: Int) -> (lat: CLLocationDegrees, lon: CLLocationDegrees) {
    ...
    public static func tile2BoundingBox(x: Int, y: Int, z: Int) -> (latBounds: (CLLocationDegrees, CLLocationDegrees), lonBounds: (CLLocationDegrees, CLLocationDegrees)) {
